...
## Yêu cầu môi trường
- PHP 8.1+ với các extension phổ biến: `OpenSSL`, `PDO`, `Mbstring`, `Tokenizer`, `XML`, `Ctype`, `JSON`, `BCMath`
- Composer 2.x
- Node.js 18+ và npm 8+
...
- Tài khoản admin: đăng nhập tại `http://127.0.0.1:8000/admin/login`.
...
- Bản đồ MVC: `docs/architecture/mvc-map.md`
- Sơ đồ tuần tự (UC chi tiết): `docs/sequence-diagrams/*-chi-tiet.puml`
- Sơ đồ hoạt động: `docs/activity-diagrams/*.puml`

> Mẹo: Dùng `php artisan route:list` để kiểm tra toàn bộ tuyến đường và middleware.
